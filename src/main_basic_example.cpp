 ...
 * 
 * Este archivo reemplaza a main.cpp para demostrar el uso básico
 * del controlador de cámara térmica sin el sistema de menús.
 * 
 * Para compilar: pio run -e basic_example
 */
